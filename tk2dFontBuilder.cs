...
{
    // 代码来源：2D Toolkit 2.5.6，不要问为什么不是最新版，能找到已经不错了
    // 找到后导入到 unity 中，进入TK2DROOT/Editor/Fonts 找到 tk2dFontBuilder.cs
    // 这里去除了与 Unity Editor 相关的代码行，以及和读取 xml 相关的代码，因为我们创建的位图字体是以 text 而不是 xml 或 binary 保存的
    public class Char
    {
